...
if len(LTsv_GUI) > 0:
    ...
    DNS8888_label_hosts=LTsv_label_new(DNS8888_window,widget_t="hosts「{0}」".format(DNS8888_hostspath),widget_x=0,widget_y=DNS8888_buttonsize*0,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_button_hosts=LTsv_button_new(DNS8888_window,event_b=DNS8888_edit_shell(DNS8888_txtedit,DNS8888_hostspath),widget_t="{0} {1}".format(DNS8888_txtedit,DNS8888_hostspath),widget_x=0,widget_y=DNS8888_buttonsize*1,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_label_dns=LTsv_label_new(DNS8888_window,widget_t="DNS「nameserver 8.8.8.8」>「{0}」".format(DNS8888_resolvpath),widget_x=0,widget_y=DNS8888_buttonsize*2,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_button_dns=LTsv_button_new(DNS8888_window,event_b=DNS8888_dnsadd_kernel,widget_t="8.8.8.8",widget_x=DNS8888_W*0//4,widget_y=DNS8888_buttonsize*3,widget_w=DNS8888_W*1//4,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_button_resolv=LTsv_button_new(DNS8888_window,event_b=DNS8888_edit_shell(DNS8888_txtedit,DNS8888_resolvpath),widget_t="{0} {1}".format(DNS8888_txtedit,DNS8888_resolvpath),widget_x=DNS8888_W*1//4,widget_y=DNS8888_buttonsize*3,widget_w=DNS8888_W*3//4,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_button_config=LTsv_button_new(DNS8888_window,event_b=DNS8888_edit_shell(DNS8888_txtedit,DNS8888_congigpath),widget_t="{0} {1}".format(DNS8888_txtedit,DNS8888_congigpath),widget_x=0,widget_y=DNS8888_H-DNS8888_buttonsize*1,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize*1,widget_f=DNS8888_fontname)
    DNS8888_label_flash=LTsv_label_new(DNS8888_window,widget_t="flash(「lsof -n | grep Flash」>「/tmp/debug0.mp4」",widget_x=0,widget_y=DNS8888_buttonsize*4,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_button_open=LTsv_button_new(DNS8888_window,event_b=DNS8888_open_kernel,widget_t="{0} {1}".format(DNS8888_filer,DNS8888_temppath),widget_x=DNS8888_W*0//5,widget_y=DNS8888_buttonsize*5,widget_w=DNS8888_W*1//5,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_combobox_flash=LTsv_combobox_new(DNS8888_window,event_b=None,widget_x=DNS8888_W*1//5,widget_y=DNS8888_buttonsize*5,widget_w=DNS8888_W*2//5,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_button_play=LTsv_button_new(DNS8888_window,event_b=DNS8888_play_kernel,widget_t=DNS8888_player,widget_x=DNS8888_W*3//5,widget_y=DNS8888_buttonsize*5,widget_w=DNS8888_W*2//5,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_label_capitle=LTsv_label_new(DNS8888_window,widget_t="「{0}」".format(DNS8888_capitle),widget_x=0,widget_y=DNS8888_buttonsize*6,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    DNS8888_entry_capitle=LTsv_entry_new(DNS8888_window,event_b=None,widget_t="",widget_x=0,widget_y=DNS8888_buttonsize*7,widget_w=DNS8888_W,widget_h=DNS8888_buttonsize,widget_f=DNS8888_fontname)
    if sys.platform.startswith("win"):
